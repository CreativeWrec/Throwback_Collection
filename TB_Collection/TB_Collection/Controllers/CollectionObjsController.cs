...
namespace TB_Collection.Controllers
{
    public class CollectionObjsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Collections.Include(c => c.Collector).Include(c => c.Item);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var collectionObj = await _context.Collections
        ...
        public async Task<IActionResult> Create([Bind("CollectorId,ItemId")] CollectionObj collectionObj)
        {
            ...
            ViewData["CollectorId"] = new SelectList(_context.Collectors, "CollectorId", "CollectorId", collectionObj.CollectorId);
            ViewData["ItemId"] = new SelectList(_context.Items, "ItemId", "ItemId", collectionObj.ItemId);
            return View(collectionObj);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var collectionObj = await _context.Collections.FindAsync(id);
            if (collectionObj == null)
            {
                return NotFound();
            }
        ...
        {
            var collectionObj = await _context.Collections.FindAsync(id);
            _context.Collections.Remove(collectionObj);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Collections.Any(e => e.CollectorId == id);
        }
    }
}
